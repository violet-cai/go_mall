...
type LoginRequest struct {
	...
	Mobile   string `protobuf:"bytes,pay,opt,name=Mobile,proto3" json:"Mobile,omitempty"`
...
type RegisterRequest struct {
	...
	Name     string `protobuf:"bytes,pay,opt,name=Name,proto3" json:"Name,omitempty"`
...
var file_rpc_user_proto_goTypes = []interface{}{
	...
	(*LoginResponse)(nil),    // pay: user.LoginResponse
...
var file_rpc_user_proto_depIdxs = []int32{
	...
	2, // pay: user.User.Register:input_type -> user.RegisterRequest
